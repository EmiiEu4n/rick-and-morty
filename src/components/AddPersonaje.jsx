...
// Definimos un componente funcional llamado AddPersonaje
export const AddPersonaje = ({ onnewPersonaje }) => {
      ...
      const onSubmit = (event) => {
        ...
        // Llamamos a la función onnewPersonaje con inputValue como argumento
